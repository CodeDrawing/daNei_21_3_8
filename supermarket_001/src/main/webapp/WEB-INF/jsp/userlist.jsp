...
<div class="right">
	...
	<div class="search">
		<form method="post" action="${pageContext.request.contextPath }/user/queryUser">
...
<%--									${user.userRole}--%>
				...
				<td>
					...
					<span><a class="modifyUser" href="${pageContext.request.contextPath }/user/toUpdateUserInfo/${user.id}" userid=${user.id } username=${user.userName }><img
							src="${pageContext.request.contextPath }/statics/images/xiugai.png" alt="修改"
							title="修改"/></a></span>
					<span><a class="deleteUser" href="${pageContext.request.contextPath }/user/deleteUser/${user.id}"
